...
// Function to validate names (no numeric characters allowed)
...
// Function to validate scores (between 0 and 10)
...
struct StudentManager {
    ...
    void printAllStudents() const {
        for (const auto& student : students) {
            ...
            std::cout << "Math Score: " << student.mathScore << ", Literature Score: " 
                      << student.literatureScore << ", Foreign Language Score: " 
                      << student.foreignLanguageScore << "\n";
