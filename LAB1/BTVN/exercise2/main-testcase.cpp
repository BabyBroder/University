...
int main()
{
    testCase(1, 4, 2, {{1, 2}, {3, 4}, {1, 3}, {2, 5}}, {2, 5}, {1, 2});
    testCase(2, 3, 1, {{3, 5}, {2, 4}, {1, 2}}, {2, 4}, {3, 5});
    testCase(3, 4, 3, {{1, 3}, {2, 6}, {3, 1}, {0, 1}}, {2, 6}, {1, 3});
    testCase(4, 3, 2, {{4, 5}, {2, 3}, {1, 2}}, {2, 3}, {2, 3});
    testCase(5, 5, 1, {{-1, 1}, {1, -1}, {0, 1}, {1, 2}, {2, 3}}, {-1, 1}, {2, 3});
    testCase(6, 5, 3, {{2, 1}, {3, 1}, {1, 1}, {4, 2}, {3, 2}}, {2, 1}, {2, 1});
    testCase(7, 4, 4, {{3, 2}, {4, 1}, {2, 3}, {1, 1}}, {4, 1}, {2, 3});
    testCase(8, 3, 3, {{5, 6}, {1, 1}, {2, 3}}, {1, 1}, {2, 3});
    testCase(9, 6, 2, {{-1, 3}, {3, 4}, {4, 5}, {2, 7}, {0, 2}, {1, 1}}, {0, 2}, {4, 5});
    testCase(10, 4, 1, {{2, 5}, {1, 2}, {1, 3}, {3, 1}}, {1, 3}, {3, 1});
    testCase(11, 5, 2, {{1, 3}, {2, 5}, {3, 4}, {1, 2}, {0, 1}}, {1, 3}, {1, 2});
    testCase(12, 4, 1, {{1, 2}, {1, 3}, {2, 3}, {3, 4}}, {1, 3}, {3, 4});
    testCase(13, 6, 3, {{-2, 3}, {4, 5}, {3, 2}, {1, 1}, {0, 1}, {2, 7}}, {2, 7}, {4, 5});
    testCase(14, 5, 4, {{-1, 2}, {2, 1}, {1, 3}, {0, 1}, {5, 3}}, {5, 3}, {0, 1});
    testCase(15, 3, 1, {{-5, 6}, {1, 2}, {3, 5}}, {-5, 6}, {3, 5});
    testCase(16, 4, 2, {{2, 5}, {1, 4}, {3, 6}, {0, 1}}, {1, 4}, {2, 5});
    testCase(17, 5, 5, {{1, 2}, {2, 3}, {3, 1}, {1, 1}, {5, 4}}, {3, 1}, {1, 2});
    testCase(18, 2, 1, {{1, 2}, {1, 3}}, {1, 3}, {1, 2});
    testCase(19, 7, 4, {{1, 1}, {2, 3}, {5, 6}, {3, 4}, {0, 1}, {1, 2}, {2, 5}}, {2, 3}, {2, 3});
    testCase(20, 4, 3, {{2, 7}, {1, 1}, {3, 5}, {4, 1}}, {1, 1}, {3, 5});
